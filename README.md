...
- 红黑树
    ...
    ![RB_TREE](src/rbtree/img/rb_tree.png)
   ...
   > 定义 性质
  	...
  	- 什么是二三树
    ![23_TREE](src/rbtree/img/2-3_tree.png)
        - 满足二分搜索树的基本性质
        - 节点可以存放一个元素或者两个元素
        - 绝对平衡二叉树
    - 如何维护平衡
     ![23_TREE](src/rbtree/img/2-3_trans.png)
  	...
  	- 红黑树和二三树
  	![23-rb](src/rbtree/img/23-rb.png)
        - 等价性
        - 2节点 等价二分搜索树黑色
        - 3节点：等价 两个黑节点 + 连接的一条红色边
    ![23-rb](src/rbtree/img/23-rb-2.png)
